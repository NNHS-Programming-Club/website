      ...
      <nav className="navbar navbar-expand-lg">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav flex-column flex-lg-row me-lg-auto align-items-start align-items-lg-center text-nowrap">
              {/*Left Side Links */}
            ...
            <ul className="navbar-nav horizontal-navbar flex-column flex-lg-row ms-lg-auto align-items-center mt-2 mt-lg-0 text-nowrap">
                    ...
                    {!darkMode && (
                      <Link to="/profile" className="nav-link">
                        <img
                          ...
                          src="images/icons/user-dark.svg"
                          alt="User icon"
                        />
                      </Link>
                    )}
              ...
              <li className="nav-item ms-2 me-2 my-2">
                ...
                {darkMode && (
                  ...
                  >
                    <img
                      className="social-logo"
                      src="images/icons/github-light.png"
                      alt="Dark GitHub logo"
                    />
                  </Link>
                )}
              </li>
