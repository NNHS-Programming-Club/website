...
export default function Profile() {
            ...
            if (auth.currentUser) {
                try {
                    ...
                    setProfile((prevProfile) => ({
                        ...
                        points: profileData.points || "None",
                    }));

                    setEditedName(profileData.name || auth.currentUser.email);
                    setEditedBio(profileData.bio || "No bio available.");
                } catch (error) {
    ...
    const contributionWeeks = useMemo(
        () => generateMockContributionData(WEEKS_TO_DISPLAY),
        []
    );
