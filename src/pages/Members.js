...
export default function Members() {
  const members = [
    ...
    { id: 6, name: "Jason Smith", role: "Member", bio: "Hello, my name is Jason. I am a sophomore who likes Guitar and Programming. I primarily program in Python and Web Development Languages, but I am trying to branch out. This is my first year attending this club."},
    { id: 7, name: "Nathan Kessler", role: "Member", bio: "Hi, my name is Nathan. I primarily code in rust, but am also able to code in Python, Java, R, SQL, C (++), and HTML/JavaScript. I like theoretical programming, and enjoy creating algorithms. You will often see me doing math or on leetcode during programming club." },
    { id: 8, name: "Raj Kasarle", role: "Member", bio: "Hello, my name is Raj. I am a student of the class of 2028, and I've had a great interest in mathematics and science, which is just some of the reasons why I decided to join Programming Club. I've always loved computers ever since I was in elementary school, and I've always wondered how I can create things on a computer. That's when I learned about coding, and ever since I started basic, going more advanced, my knowledge expanded faster than a cheetah could run. My favorite coding language (and most challenging, of course) is C, one of the oldest languages. I am still learning, and I am willing to learn more and help others. My favorite parts of Programming Club are the challenges from short problems we attempt to solve (yes, that's how we practice coding!) The varieties and possibilities in programing are endless, and I think Programming Club is a really insightful club to think about!"},
    { id: 9, name: "Theo Karon", role: "Member", bio: "i do dumb stuff with linux, and write dumb scripts for dumb stuff. i hate computers, they don't work except for when they do, which when they do they don't"},
    { id: 10, name: "Veronica Gordivsky", role: "Member", bio: "I'm Veronica, and I first started getting into programming in high school. I also enjoy drawing, reading, and snorkeling/scuba diving. I’m also knowledgeable on animals, my favorite being cats, and I have a pet bird (he's a cockatiel). "},
    { id: 11, name: "ZZ Zhang", role: "Member", bio: "Heyo, I'm ZZ. I started doing programming because I wanted to code for robots. I like the programming club because it provides competition opportunities and teaches me more in depth things about programming. My other hobbies are playing the flute, boxing, and watching Studio Ghibli movies."}
  ];
