...
export default function Members() {
  const members = [
    ...
    { id: 2, name: "Alyssa Yasuhara", role: "Member", bio: "I like coding in python, and I am currently learning java. I love the community aspect of programming club and learning together with my peers!"},
    { id: 3, name: "Anastasia Gordivsky", role: "Member", bio: "I am interested in programming because you get to create cool things such as websites and a variety of computer programs, and you also get to make big changes in various industries by creating computer programs! I like how programming club teaches you a lot about computer science and the activities that we do every week! My other hobbies are violin, reading, spending time outdoors, swimming, and biking!" },
    ...
    { id: 5, name: "Eli Rappa", role: "Member", bio: "I am interested in programming because I want to become a roblox game developer. I like that programming club is open to all skill levels of programming. My other hobbies are watching anime, playing video game, and playing the trumpet."},
    { id: 6, name: "Ewan McPhail", role: "Member", bio: "I mostly write C++, and do some reverse engineering. Check out my page (https://undisassemble.github.io) or my GitHub (https://github.com/undisassemble). The artwork on the side is done by my sister (who is awesome)." },
    { id: 7, name: "Jason Smith", role: "Member", bio: "Hello, my name is Jason. I am a sophomore who likes Guitar and Programming. I primarily program in Python and Web Development Languages, but I am trying to branch out. This is my first year attending this club."},
    { id: 8, name: "Nathan Kessler", role: "Member", bio: "Hi, my name is Nathan. I primarily code in rust, but am also able to code in Python, Java, R, SQL, C (++), and HTML/JavaScript. I like theoretical programming, and enjoy creating algorithms. You will often see me doing math or on leetcode during programming club." },
    { id: 9, name: "Raj Kasarle", role: "Member", bio: "Hello, my name is Raj. I am a student of the class of 2028, and I've had a great interest in mathematics and science, which is just some of the reasons why I decided to join Programming Club. I've always loved computers ever since I was in elementary school, and I've always wondered how I can create things on a computer. That's when I learned about coding, and ever since I started basic, going more advanced, my knowledge expanded faster than a cheetah could run. My favorite coding language (and most challenging, of course) is C, one of the oldest languages. I am still learning, and I am willing to learn more and help others. My favorite parts of Programming Club are the challenges from short problems we attempt to solve (yes, that's how we practice coding!) The varieties and possibilities in programing are endless, and I think Programming Club is a really insightful club to think about!"},
    { id: 10, name: "Theo Karon", role: "Member", bio: "i do dumb stuff with linux, and write dumb scripts for dumb stuff. i hate computers, they don't work except for when they do, which when they do they don't"},
    { id: 11, name: "Veronica Gordivsky", role: "Member", bio: "I'm Veronica, and I first started getting into programming in high school. I also enjoy drawing, reading, and snorkeling/scuba diving. I’m also knowledgeable on animals, my favorite being cats, and I have a pet bird (he's a cockatiel). "},
